...
int main(int argc, char** argv){
  ...
  if (RuntimeArgs.is_valid()){
    ...
    if (number_of_excited_states>0){
      ajaj::DataOutput ex_results(ajaj::OutputName(RuntimeArgs.filename(),"Excited_Energies.dat"),"Sweep Index, State Index, Energy/vertex, Entropy, Truncation, 1"); //open file for output
