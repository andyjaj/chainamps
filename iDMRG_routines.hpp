...
namespace ajaj {
  ...
  public:
    ...
    void load(const std::string& initfilename); //Create superblock my loading in an MPS and applying Hamiltonian to it.
    void load(const c_specifier_array& cspec); //Create superblock from simple product state description, and apply Hamiltonian to it.
