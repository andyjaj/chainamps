...
namespace ajaj { 
 ...
 //////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////
  inline SparseMatrix conj_multiply(const SparseMatrix& A, bool conjA, const SparseMatrix& B, bool conjB){
    if (conjA) {
      if (conjB)
	return A.copy_conjugate() * B.copy_conjugate();
      else
	return A.copy_conjugate() * B;
    }
    else if (conjB)
      return A * B.copy_conjugate();
